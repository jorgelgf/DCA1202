...
{
    ifstream inputFile;
    inputFile.open("/home/jorge/Mais\ uma\ vez/projetoPA2/arquivos/Desenho");
    if(!inputFile)
    {
       exit(0);
    }
    ...
    t.writeOFF("/home/jorge/Mais\ uma\ vez/projetoPA2/arquivos/off.off");
    t.writeVECT("/home/jorge/Mais\ uma\ vez/projetoPA2/arquivos/vect.vect");
